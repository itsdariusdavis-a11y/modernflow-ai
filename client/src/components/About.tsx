...
const CONTRACTOR_IMG = "https://d2xsxph8kpxj0f.cloudfront.net/310419663029667540/GXtnUFss9AoWw228KaXxY6/contractor-working-EHYj8tcmvND9cdk39UWPR6.webp";
      ...
      <div className="container">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            >
              We Are{" "}
              <span className="gradient-text">ModernFlow AI.</span>
            </h2>
            ...
            <div className="space-y-4 text-[oklch(0.65_0.02_155.83)] leading-relaxed">
              <p>
                ModernFlow AI was founded on a simple principle: service business owners
                should focus on their craft, not on chasing leads and managing paperwork.
              </p>
              <p>
                Too many potential clients slip through the cracks due to missed calls, slow
                follow-up, and a lack of a centralized system. We've seen it happen to
                hundreds of contractors — good businesses losing revenue because they
                can't respond fast enough.
              </p>
              <p>
                We solve this by implementing powerful, AI-driven automation that handles
                the entire client lifecycle — from first contact to the final review request. Our
                platform acts as the central brain for your business, ensuring every lead is
                captured, nurtured, and converted.
              </p>
            </div>
